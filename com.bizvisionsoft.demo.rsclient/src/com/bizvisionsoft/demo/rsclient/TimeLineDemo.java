...
public class TimeLineDemo {
	...
	private void createTimeLine(Composite parent) {
		...
		tl.append("8月17日", "因客户要求的变化，涉及到A模块多处设计更改，部分组件必须重新设计。杨文韬发起项目变更，预计项目将延期30天。");
		tl.append("8月18日", "方案设计完成。");
		tl.append("8月20日", "杨文韬下达了A模块结构设计，B模块结构设计等工作的计划。");
		tl.append("8月22日", "样机试验结果满足了要求。样机开发完成。");
		tl.append("9月24日", "杨文韬提交了A模块最终的研发成果物。");
		tl.append("10月9日", "A模块设计评审工作已完成。");
		tl.append("11月20日", "杨文韬发起到了A模块的设计评审工作。");
	}
