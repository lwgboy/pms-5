...
public class CreateD0ERA {
	...
	public void execute(@MethodParam(Execute.CONTEXT) BruiAssemblyContext context,
		...
		Editor.create("D0-ERA-±à¼­Æ÷", context, new Document("problem_id", problem.get_id()), true).ok((r, t) -> {
			t = Services.get(ProblemService.class).insertD0ERA(t, RWT.getLocale().getLanguage(),render);
