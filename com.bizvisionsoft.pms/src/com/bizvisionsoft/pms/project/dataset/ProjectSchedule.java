...
public class ProjectSchedule {
	...
	@DataSet({ "项目进度计划表/list", "项目进度计划表（查看）/list", "进度计划和监控/list" , "进度计划和监控（查看）/list" , "进度计划/list"})
	...
	@DataSet({ "项目进度计划表/count", "项目进度计划表（查看）/count", "进度计划和监控/count","进度计划和监控（查看）/count","进度计划/count" })
