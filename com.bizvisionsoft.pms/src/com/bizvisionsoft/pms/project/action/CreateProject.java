...
public class CreateProject {
	...
	public void execute(@MethodParam(Execute.CONTEXT) IBruiContext context) {
		Project input = br.newInstance(Project.class).setStatus(ProjectStatus.Created).setStageEnable(true)
				.setCreationInfo(br.operationInfo());
		Editor.create("创建项目编辑器.editorassy", context, input, false).ok((r, proj) -> {
