...
public class WorkBoardRender2 {
	...
	private void renderContent(ViewerCell cell, Work work) {
		...
		sb.append("<div style='width:120px;'><img src='"+"/bvs/svg?type=progress&percent="+ind+"&bgColor=81d4fa&fgColor=0091ea"+"' width=120 height=120/>");
		sb.append("<div style='color:#757575;width:120px;text-align:center;'>工作量完成</div></div>");
		...
		ind = (ind==null||ind<0)?0:(double)Math.round(ind*100)/100;
		sb.append("<div style='width:120px;'><img src='"+"/bvs/svg?type=progress&percent="+ind+"&bgColor=81d4fa&fgColor=0091ea"+"' width=120 height=120/>");
		sb.append("<div style='color:#757575;width:120px;text-align:center;'>工期完成</div></div>");

		sb.append("<div style='float:right;display:inline-flex;width:100%;justify-content:flex-end;padding-right:24px'>");
		/////////////////////////////////////////////////////////////////////////////////////////////////////////
		// 工作包按钮
		List<TrackView> wps = work.getWorkPackageSetting();
		if (EngUtil.isEmptyOrNull(wps)) {
			sb.append(
					"<a class='layui-btn layui-btn-sm layui-btn-primary' style='float:right;margin-bottom:8px;margin-right:4px;' href='"
