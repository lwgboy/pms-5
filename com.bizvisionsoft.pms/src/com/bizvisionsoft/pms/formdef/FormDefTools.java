...
public class FormDefTools {
	...
	public static boolean checkFormDef(IBruiService br, FormDef formDef) {
		...
		return showResult(br, result, "导出文档规则检查", "检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性检查导出文档规则完整性");
	}
