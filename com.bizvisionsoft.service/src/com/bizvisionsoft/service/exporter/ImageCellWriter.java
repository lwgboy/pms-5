...
public class ImageCellWriter extends CellWriter {
	...
	public ImageCellWriter(ExportableFormField f, Object value, int width) {
		super(f);
		this.value = value;
		this.width = width;
	}
	...
	public void write(org.apache.poi.xwpf.usermodel.XWPFTableCell cell) {
		if (value instanceof String[]) {
			write(cell, (String[]) value);
		} else if (value instanceof RemoteFile) {
			write(cell, new String[] { ((RemoteFile) value).getServerSideURL(), ((RemoteFile) value).name });
		}
	}

	private void write(XWPFTableCell cell, String[] value) {
