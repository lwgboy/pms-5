...
public class WorkLink {
	...
	@ReadValue({ "项目甘特图/id", "项目甘特图（编辑）/id", "项目甘特图（无表格查看）/id", "项目甘特图（资源分配）/id" })
	public String getId() {
		return _id.toHexString();
	}

	@WriteValue({ "项目甘特图/id", "项目甘特图（编辑）/id", "项目甘特图（无表格查看）/id", "项目甘特图（资源分配）/id" })
	...
	@ReadValue({ "项目甘特图/source", "项目甘特图（编辑）/source", "项目甘特图（无表格查看）/source" , "项目甘特图（资源分配）/source"})
	...
	@ReadValue({ "项目甘特图/target", "项目甘特图（编辑）/target", "项目甘特图（无表格查看）/target", "项目甘特图（资源分配）/target" })
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	//
	@ReadValue({ "项目甘特图/lag", "项目甘特图（编辑）/lag", "项目甘特图（无表格查看）/lag", "项目甘特图（资源分配）/lag" })
	@WriteValue({ "项目甘特图/lag", "项目甘特图（编辑）/lag", "项目甘特图（无表格查看）/lag" , "项目甘特图（资源分配）/lag"})
	@Persistence
	private int lag;
