...
public interface ProjectTemplateService {
	...
	public long updateWork(@MethodParam(MethodParam.FILTER_N_UPDATE) BasicDBObject bson,
			@MethodParam(MethodParam.DOMAIN) @PathParam("domain") String domain);
	...
	public List<OBSInTemplate> getOBSTemplate(@PathParam("_id") @MethodParam(MethodParam.ROOT_CONTEXT_INPUT_OBJECT_ID) ObjectId template_id,
			@MethodParam(MethodParam.DOMAIN) @PathParam("domain") String domain);
	...
	public long updateOBSItem(@MethodParam(MethodParam.FILTER_N_UPDATE) BasicDBObject fu,
			@MethodParam(MethodParam.DOMAIN) @PathParam("domain") String domain);
	...
	public List<WorkInTemplate> listWBSRoot(@PathParam("_id") @MethodParam(MethodParam.ROOT_CONTEXT_INPUT_OBJECT_ID) ObjectId template_id,
			@MethodParam(MethodParam.DOMAIN) @PathParam("domain") String domain);
	...
	public long countWBSRoot(@PathParam("_id") @MethodParam(MethodParam.ROOT_CONTEXT_INPUT_OBJECT_ID) ObjectId template_id,
			@MethodParam(MethodParam.DOMAIN) @PathParam("domain") String domain);
	...
	public long updateOBSModule(@MethodParam(MethodParam.FILTER_N_UPDATE) BasicDBObject filterAndUpdate,
			@MethodParam(MethodParam.DOMAIN) @PathParam("domain") String domain);
