...
public class AbstractRenderer {
	...
	protected static void renderTitle(CardTheme theme, StringBuffer sb, Work work, Date date) {
	...
	protected static void renderIconTextLine(StringBuffer sb, String text, String icon, String color) {
	...
	protected static void renderProjectLine(CardTheme theme, StringBuffer sb, Work work) {
	...
	protected static void renderCharger(CardTheme theme, StringBuffer sb, Work work) {
		renderUser(sb, work, "负责", work.warpperChargerInfo(), theme.emphasizeText);
	}

	protected static void renderUser(StringBuffer sb, Work work, String title, String text, String color) {
		sb.append("<div style='padding-left:8px;padding-top:8px;display:flex;align-items:center;'><img src='"
	...
	protected static void renderNoticeBudgets(StringBuffer sb, Work work) {
	...
	protected static void renderButtons(CardTheme theme, StringBuffer sb, Work work, String label, String href) {
		renderButtons(theme, sb, work, true, label, href);
	}

	protected static void renderButtons(CardTheme theme, StringBuffer sb, Work work, boolean showActionButton, String label, String href) {
	...
	protected static void renderIndicators(CardTheme theme, StringBuffer sb, String label1, double ind1, String label2, double ind2) {
