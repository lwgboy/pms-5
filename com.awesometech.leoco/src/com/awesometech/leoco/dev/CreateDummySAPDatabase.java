...
public class CreateDummySAPDatabase {
	...
	public void execute() {
		try {
			...
			stmt.executeUpdate("insert into V_PMS_SO (so_num, prt_num, prt_desc,unit,qty) values ('SO01','P01','产品A','PCS',10)");
			stmt.executeUpdate("insert into V_PMS_SO (so_num, prt_num, prt_desc,unit,qty) values ('SO02','P02','产品B','PCS',60)");
			//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// 创建SO-->Pr表
			stmt.executeUpdate(
			...
			stmt.executeUpdate(
					"insert into V_PMS_PO_IN (po_num,po_idx, prt_num,prt_desc,unit,qty,adate) values "
